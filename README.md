...
本插件为**一次性买断**，无订阅、无有效期，付款后获得专属激活码，永久可用。

- **限时早鸟价**：¥49（前期限量，恢复正式价后不再有）
- **正式价**：¥9999
...
- **Limited-time early-bird price**: ¥49 (limited, before the regular price takes effect)
- **Regular price**: ¥9999
