...
window.setupBambooTooltips = setupBambooTooltips;window._renderDebounceTimer = _renderDebounceTimer;
window._isRendering = _isRendering;
window._pendingRender = _pendingRender;
window._renderedSectionIds = _renderedSectionIds;
window.renderDate = renderDate;
window._iconSvg = _iconSvg;
window.computeActiveDuration = computeActiveDuration;
window.stubIconClock = stubIconClock;
window.stubIconList = stubIconList;
window.stubIconFlip = stubIconFlip;
window.stubIconFlipBack = stubIconFlipBack;
window.buildStubBackHTML = buildStubBackHTML;
window.buildTicketHTML = buildTicketHTML;
window.PERIOD_HOURS = PERIOD_HOURS;
window.PERIOD_ORDER = PERIOD_ORDER;
